...
public class FilterPriceDesc {

    ChromeDriver driver;
    private final String SCREENSHOTS = "./src/test/onDemandScreenShots";

    public FilterPriceDesc(ChromeDriver driver){
        this.driver = driver;
    ...
    @Test
    @DisplayName("test-Filter-Price-Descending")
    void shouldFilterPriceDescending(TestInfo testInfo) throws Exception{
...
*/
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("priceDsc")).click();
        Thread.sleep(2000);
        try{
            Thread.sleep(3000);
        }
