...
public class FilterNameAsc {

    ChromeDriver driver;
    private final String SCREENSHOTS = "./src/test/onDemandScreenShots";

    public FilterNameAsc(ChromeDriver driver){
        this.driver = driver;
    ...
    @Test
    @DisplayName("test-Filter-Name-Ascending")
    void shouldFilterNameAsc(TestInfo testInfo) throws Exception{
...
*/
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("nameAsc")).click();
        Thread.sleep(2000);
        try{
            Thread.sleep(3000);
        }
