...
public class FilterPriceAscending {

    ChromeDriver driver;
    private final String SCREENSHOTS = "./src/test/onDemandScreenShots";

    public FilterPriceAscending(ChromeDriver driver){
        this.driver = driver;
    ...
    @Test
    @DisplayName("test-Filter-Price-Ascending")
    void shouldFilterPriceAscending(TestInfo testInfo) throws Exception{
...
*/
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("priceAsc")).click();
        Thread.sleep(2000);
        try{
            Thread.sleep(3000);
        }
