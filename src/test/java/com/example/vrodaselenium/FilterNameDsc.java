...
public class FilterNameDsc {

    ChromeDriver driver;
    private final String SCREENSHOTS = "./src/test/onDemandScreenShots";

    public FilterNameDsc(ChromeDriver driver){
        this.driver = driver;
    ...
    @Test
    @DisplayName("test-Filter-Name-Descending")
    void shouldFilterNameDsc(TestInfo testInfo) throws Exception{
...
*/
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("nameDsc")).click();
        Thread.sleep(2000);
        try{
            Thread.sleep(3000);
        }
